...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <hr id="ko-fi">
            <h3 class="text-center integration-title">Ko-Fi Integration</h3><br>
            <content class="d-flex flex-wrap align-items-center justify-content-center flexbox-mobile mb-10 mt-10">
                    <div class="half-col">
            ...
            <hr id="buymeacoffee">
            <h3 class="text-center integration-title">Buy Me A Coffee Integration</h3><br>
            <content class="d-flex flex-wrap align-items-center justify-content-center flexbox-mobile mb-10 mt-10">
                    <div class="half-col">
            ...
            <hr id="patreon">
            <h3 class="text-center integration-title">Patreon Integration</h3><br>
            <content class="d-flex flex-wrap align-items-center justify-content-center flexbox-mobile mb-10 mt-10">
                    <div class="half-col">
